                        ...
                        <form @submit.prevent="savelicense" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <label class="inputlabel">New Owner Name.</label>
                                            <TextInput type="text"  class="mt-1 block w-full" v-model="vehicle.newownername" aria-required="true"/>
                                        </div>
                                        <div class="col-4">
                                            <label class="inputlabel">New Owner NIC.</label>
                                            <TextInput type="text"  class="mt-1 block w-full" v-model="vehicle.newownernic" aria-required="true" />
                                        </div>
                                        <div class="col-4">
                                            <label class="inputlabel">New Owner's Address.</label>
                                            <TextInput type="text"  class="mt-1 block w-full"  v-model="vehicle.newowneraddress"  aria-required="true" />
                                        </div>
                                        <div class="col-4">
                                            <label class="inputlabel">Date of Transfer.</label>
                                            <TextInput type="date"  class="mt-1 block w-full"  v-model="vehicle.transferdate"  aria-required="true" />
                                        </div>
                                    </div>
                                    <br>
    ...
    async savelicense() {
        try {
            const formData = new FormData();
                ...
                await this.$inertia.post('/savevehicalrenew', formData, {
                    headers: {
